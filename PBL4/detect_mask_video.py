...
class MainWindow(QWidget):
                ...
                if faces_found > 0:
                    ...
                    for i in range(faces_found):
                        ...
                        if (bb[i][3] - bb[i][1]) / frame.shape[0] > 0.25:
                            ...
                            people=[{"Name": best_name,"Time":time_string}]
                            for person in people:
                                self.ui.tableWidget.setItem(id,0,QtWidgets.QTableWidgetItem(person["STT"]))
                                self.ui.tableWidget.setItem(id, 1, QtWidgets.QTableWidgetItem(person["Name"]))
                                self.ui.tableWidget.setItem(id, 2, QtWidgets.QTableWidgetItem(person["Time"]))
    ...
    def Xuatfile(self):
        ...
        with open('ListViPham.csv', 'r') as f:
            for row in csv.reader(f):
                ws.append(row)
        wb.save('ListViPham.xlsx')
